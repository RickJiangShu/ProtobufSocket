...
namespace ProtoBuf
{
    ...
    internal sealed class Helpers
    {
...
#if DEBUG
#if MF      
            Microsoft.SPOT.Debuger.Print(message);
#else
        ...
        public static void TraceWriteLine(string message)
        {
            ...
            System.Diagnostics.Debuger.WriteLine(message);
#else
        ...
        public static void DebugAssert(bool condition, string message)
        {
            ...
            {
#if MF
                Microsoft.SPOT.Debuger.Assert(false, message);
#else
...
#if DEBUG   
#if MF
            Microsoft.SPOT.Debuger.Assert(condition);
#else
